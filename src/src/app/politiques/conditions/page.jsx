...
const sections = [
    ...
    content: (
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        {[
          ...
          <div key={idx} style={{ background: "rgba(0,95,105,0.05)", border: "1.5px solid rgba(0,95,105,0.12)", borderRadius: 12, padding: "16px 20px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          {[
            ...
            <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12, padding: "16px", background: "rgba(0,95,105,0.05)", borderRadius: 12, border: "1.5px solid rgba(0,95,105,0.12)" }}>
    ...
    content: (
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {[
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 16px", background: ok ? "rgba(0,95,105,0.05)" : "rgba(255,140,0,0.06)", borderRadius: 10, border: `1.5px solid ${ok ? "rgba(0,95,105,0.12)" : "rgba(255,140,0,0.18)"}` }}>
            <Icon weight="bold" style={{ width: 18, height: 18, color: ok ? "#005f69" : "#e07b00", flexShrink: 0 }} />
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
          {[
            ...
            <div key={i} style={{ textAlign: "center", padding: "20px 14px", background: "white", borderRadius: 14, border: "1.5px solid rgba(0,95,105,0.12)", boxShadow: "0 2px 12px rgba(0,95,105,0.06)" }}>
              <div style={{ width: 44, height: 44, borderRadius: 12, background: "rgba(0,95,105,0.10)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 12px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 18px", background: "rgba(0,95,105,0.07)", borderRadius: 12, border: "1.5px solid rgba(0,95,105,0.18)" }}>
          <Lock weight="bold" style={{ width: 18, height: 18, color: "#005f69", flexShrink: 0 }} />
          <p style={{ fontSize: 14, color: "#005f69", fontWeight: 600 }}>
  ...
  },
  {
    ...
    content: (
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        <div style={{ padding: "14px 18px", background: "rgba(0,95,105,0.07)", borderRadius: 12, borderLeft: "4px solid #005f69" }}>
        ...
        {[
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", background: "rgba(220,38,38,0.04)", borderRadius: 10, border: "1.5px solid rgba(220,38,38,0.12)" }}>
            <XCircle weight="bold" style={{ width: 18, height: 18, color: "#dc2626", flexShrink: 0 }} />
            <span style={{ fontSize: 14, color: "#374151" }}>{item}</span>
          </div>
        ))}
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 16px", background: "rgba(255,140,0,0.06)", borderRadius: 10, border: "1.5px solid rgba(255,140,0,0.18)" }}>
          <Warning weight="bold" style={{ width: 18, height: 18, color: "#e07b00", flexShrink: 0 }} />
          <span style={{ fontSize: 14, color: "#374151", fontWeight: 500 }}>L'utilisateur doit vérifier que son véhicule est correctement stationné et fermé.</span>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div style={{ padding: "20px 24px", background: "linear-gradient(135deg, rgba(0,95,105,0.07) 0%, rgba(0,95,105,0.03) 100%)", borderRadius: 14, border: "1.5px solid rgba(0,95,105,0.15)" }}>
  ...
  },
  {
    ...
    content: (
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "13px 18px", background: "rgba(0,95,105,0.07)", borderRadius: 12, border: "1.5px solid rgba(0,95,105,0.18)" }}>
  ...
  },
  {
    ...
    content: (
      <div style={{ padding: "20px 24px", background: "rgba(255,180,0,0.06)", borderRadius: 14, border: "1.5px solid rgba(255,180,0,0.22)", borderLeft: "4px solid #f59e0b" }}>
        <p style={{ color: "#4b6366", lineHeight: 1.85, fontSize: 15 }}>
  ...
  },
  {
    ...
    content: (
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "16px 20px", background: "rgba(0,95,105,0.06)", borderRadius: 12, border: "1.5px solid rgba(0,95,105,0.14)" }}>
          <Scales weight="bold" style={{ width: 22, height: 22, color: "#005f69", flexShrink: 0 }} />
          <div>
        ...
        {[
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 14, padding: "12px 16px", background: "rgba(0,95,105,0.04)", borderRadius: 10, border: "1.5px solid rgba(0,95,105,0.10)" }}>
  ...
  },
  {
    ...
    title: "Contact",
    content: (
      <div style={{ background: "linear-gradient(135deg, #005f69 0%, #004a52 100%)", borderRadius: 16, padding: "28px 32px" }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 24 }}>
        <div style={{ width: 48, height: 48, borderRadius: 14, background: "#005f69", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          <Icon weight="bold" style={{ width: 24, height: 24, color: "white" }} />
        </div>
        <div>
          ...
          <h2 style={{ fontSize: "clamp(17px,2vw,22px)", fontWeight: 900, color: "#0a1a1c", letterSpacing: "-0.3px", lineHeight: 1.1, marginTop: 2 }}>{section.title}</h2>
        </div>
      </div>
...
export default function TermsAndConditionsPage() {
  return (
    <div style={{ fontFamily: "'Archivo', sans-serif", background: "#ecf5f5", minHeight: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      {/* ══ HERO ══ */}
      <div style={{ background: "linear-gradient(160deg, #004a52 0%, #005f69 60%, #007a8a 100%)", padding: "clamp(100px,12vw,140px) 24px clamp(60px,8vw,90px)", textAlign: "center", position: "relative", overflow: "hidden", zIndex: 2 }}>
        {/* Cercles déco fond */}
        <div style={{ position: "absolute", top: "-30%", right: "-10%", width: 400, height: 400, borderRadius: "50%", background: "rgba(255,255,255,0.04)", pointerEvents: "none" }} />
        <div style={{ position: "absolute", bottom: "-20%", left: "-8%", width: 300, height: 300, borderRadius: "50%", background: "rgba(255,255,255,0.03)", pointerEvents: "none" }} />

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <div style={{ width: 56, height: 56, borderRadius: 16, background: "rgba(255,255,255,0.15)", backdropFilter: "blur(8px)", border: "1.5px solid rgba(255,255,255,0.25)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 24px" }}>
            <FileText weight="bold" style={{ width: 28, height: 28, color: "white" }} />
          </div>
          <span style={{ display: "inline-block", background: "rgba(255,255,255,0.12)", border: "1px solid rgba(255,255,255,0.2)", color: "rgba(255,255,255,0.85)", fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", padding: "5px 18px", borderRadius: 999, marginBottom: 20 }}>
            Dernière mise à jour — 2025
          </span>
          <h1 style={{ fontSize: "clamp(28px,4vw,48px)", fontWeight: 900, color: "white", letterSpacing: "-1px", lineHeight: 1.1, marginBottom: 16 }}>
            Conditions Générales<br />d'Utilisation
          </h1>
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: 17, maxWidth: 500, margin: "0 auto", lineHeight: 1.75 }}>
      ...
      {/* ══ INTRO CARD ══ */}
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px", position: "relative", zIndex: 2, marginTop: -32 }}>
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.2 }}
          style={{ background: "white", borderRadius: 20, padding: "28px 36px", borderTop: "4px solid #005f69", boxShadow: "0 12px 40px rgba(0,95,105,0.14)", display: "flex", alignItems: "center", gap: 20 }}
        >
          <div style={{ width: 48, height: 48, borderRadius: 14, background: "rgba(0,95,105,0.10)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
      ...
      {/* ══ SECTIONS ══ */}
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "40px 24px 100px", display: "flex", flexDirection: "column", gap: 20, position: "relative", zIndex: 2 }}>
