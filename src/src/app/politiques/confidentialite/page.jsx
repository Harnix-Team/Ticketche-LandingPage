  ...
  >
    ...
    <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: 8 }}>
      {items.map((it, i) => (
        ...
        >
          <CheckCircle size={14} color={T} weight="fill" />
          {it}
        </li>
      ))}
    </ul>
...
const PurposeCard = ({ num, title, desc }) => (
  <motion.div
    whileHover={{ y: -3, boxShadow: `0 8px 28px rgba(0,95,105,0.12)` }}
    style={{
      background: "#fff",
      border: `1px solid #d4eaed`,
      borderRadius: 14,
  ...
  >
    ...
    <p style={{ margin: "0 0 4px", fontSize: 13, fontWeight: 700, color: TB, fontFamily: "'Archivo', sans-serif" }}>
      {title}
    </p>
    <p style={{ margin: 0, fontSize: 12, color: "#1a1a1a", fontFamily: "'Archivo', sans-serif" }}>
      {desc}
    </p>
  </motion.div>
);
...
const SecCard = ({ icon: Icon, title, desc }) => (
  <motion.div
    whileHover={{ y: -4, boxShadow: `0 10px 32px rgba(0,95,105,0.13)` }}
    style={{
      background: "#fff",
      border: `1px solid #d4eaed`,
      borderRadius: 14,
...
const RightCard = ({ icon: Icon, title, desc }) => (
  ...
  >
    ...
    <div>
      <p style={{ margin: "0 0 2px", fontSize: 13, fontWeight: 700, color: TB, fontFamily: "'Archivo', sans-serif" }}>
        {title}
      </p>
      <p style={{ margin: 0, fontSize: 12, color: "#1a1a1a", fontFamily: "'Archivo', sans-serif" }}>
        {desc}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 12 }}>
          {[
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: 14, fontWeight: 600, color: TB, fontFamily: "'Archivo', sans-serif" }}>
                {type}
              </p>
            </div>
          ))}
    ...
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            <p style={{ margin: "0 0 14px", fontSize: 14, fontWeight: 700, fontFamily: "'Archivo', sans-serif" }}>
      ...
      >
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          >
            ...
            >
              <Shield size={32} color="#fff" weight="duotone" />
            </div>
