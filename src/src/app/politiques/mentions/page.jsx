    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          style={{ flexShrink: 0, color: open ? T : "#9ab8bb" }}
        >
...
const ListItem = ({ icon: Icon, title, desc }) => (
  ...
  >
    ...
    <div>
      <p style={{ margin: "0 0 3px", fontSize: 14, fontWeight: 700, color: TB, fontFamily: "'Archivo', sans-serif" }}>
        {title}
      </p>
      {desc && (
        <p style={{ margin: 0, fontSize: 13, color: "#1a1a1a", fontFamily: "'Archivo', sans-serif" }}>
          {desc}
        </p>
      )}
    </div>
...
export default function MentionsLegalesPage() {
  const sections = [
    ...
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <TextBlock>
            Le site et l'application Ticketché sont hébergés par des prestataires tiers certifiés garantissant la sécurité, la disponibilité et l'intégrité des données.
          </TextBlock>
          <Notice icon={ShieldCheck}>
            Les serveurs d'hébergement sont soumis à des audits de sécurité réguliers et respectent les normes en vigueur en matière de protection des données personnelles.
          </Notice>
        </div>
      ),
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <TextBlock>
            L'ensemble des contenus présents sur le site et l'application Ticketché — incluant, sans s'y limiter, les textes, graphismes, logos, icônes, images, sons et logiciels — sont la propriété exclusive de <strong>Harnix-Team</strong> ou de ses partenaires, et sont protégés par les lois en vigueur relatives à la propriété intellectuelle.
          </TextBlock>
    ...
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <TextBlock>
            Ticketché s'efforce de fournir des informations exactes et à jour sur sa plateforme. Cependant, nous ne pouvons garantir l'exactitude, l'exhaustivité ou l'actualité de ces informations.
          </TextBlock>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <ListItem
              icon={Warning}
    ...
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <TextBlock>
            La création de liens hypertextes vers le site Ticketché est autorisée sous réserve de ne pas porter atteinte à l'image de la marque. En revanche, les liens en profondeur (<em>deep linking</em>) ainsi que les techniques de <em>framing</em> sont formellement interdits sans accord préalable écrit de Harnix-Team.
          </TextBlock>
          <Notice icon={Warning}>
            Tout lien non autorisé sera considéré comme une violation des présentes mentions légales et pourra faire l'objet de poursuites.
          </Notice>
        </div>
      ),
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <TextBlock>
            La collecte et le traitement des données personnelles des utilisateurs sont encadrés par notre Politique de confidentialité, disponible sur notre plateforme. Ticketché s'engage à respecter la réglementation applicable en matière de protection des données personnelles.
          </TextBlock>
          <div
            style={{
              display: "flex",
    ...
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <TextBlock>
            L'application Ticketché utilise des technologies de traçage fonctionnel (équivalentes aux cookies) pour assurer le bon fonctionnement du service, mémoriser vos préférences et améliorer votre expérience utilisateur.
          </TextBlock>
          <TextBlock>
            Aucun cookie publicitaire ou de profilage tiers n'est utilisé sans votre consentement explicite. Vous pouvez gérer vos préférences directement depuis les paramètres de l'application.
          </TextBlock>
        </div>
      ),
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <TextBlock>
            Les présentes mentions légales sont régies par le droit béninois. En cas de litige relatif à l'utilisation du site ou de l'application Ticketché, et à défaut de résolution amiable, les tribunaux compétents du Bénin seront seuls compétents.
          </TextBlock>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <ListItem
              icon={Gavel}
              title="Droit applicable"
              desc="Droit de la République du Bénin"
            />
            <ListItem
              icon={Bank}
              title="Juridiction compétente"
              desc="Tribunaux compétents d'Abomey-Calavi, Bénin"
            />
            <ListItem
              icon={Scales}
    ...
    },
    {
      ...
      content: (
        ...
        >
          <TextBlock>
            Harnix-Team se réserve le droit de modifier les présentes mentions légales à tout moment, notamment pour se conformer à toute évolution légale, jurisprudentielle ou technique. La version en vigueur est celle accessible sur la plateforme. Nous vous encourageons à la consulter régulièrement.
          </TextBlock>
        </div>
      ),
    },
  ...
  return (
    <div style={{ fontFamily: "'Archivo', sans-serif", minHeight: "100vh", background: TLL }}>

      {/* ── HERO ── */}
      <div
        style={{
          background: `linear-gradient(135deg, ${TB} 0%, ${T} 100%)`,
          color: "#fff",
      ...
      >
        ...
        <div style={{ maxWidth: 720, margin: "0 auto", textAlign: "center", position: "relative" }}>
          ...
          >
            ...
            >
              <Gavel size={32} color="#fff" weight="duotone" />
            </div>
      ...
      <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 20px", marginTop: -40, position: "relative", zIndex: 10 }}>
        <motion.div
          ...
          style={{
            background: "#fff",
            borderRadius: 20,
            boxShadow: "0 12px 48px rgba(0,95,105,0.15)",
            padding: "28px 32px",
            borderTop: `4px solid ${T}`,
          }}
        >
          <p
            style={{
