        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="flex flex-col items-center justify-end sm:items-end overflow-visible pb-0 mb-0">
              <img
                src="/images/Download/download2.png"
                alt="Ticketché App Mockup"
                className="rounded-t-2xl object-contain object-bottom"
style={{ width: "120%", maxWidth: "700px", marginLeft: "auto", marginRight: "-300px", marginTop: "140px", transform: "scale(1.9)", transformOrigin: "bottom right" }}
              />
            </div>
          </div>
        </div>
