...
export const CTASection = () => {
  return (
    <section
      id="download"
      className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pt-8 md:pt-12 lg:pt-16 lg:rounded-3xl bg-[#005F69] text-white overflow-hidden"
    >
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-4">
              <div className="flex-1">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 md:mb-6">
                  ticketché, le moyen le plus facile, rapide, et sécurisé !
                </h2>

                <p className="text-base sm:text-lg lg:text-xl text-white/80 mb-6 md:mb-8">
                  Simplifiez la gestion de vos véhicules avec une application
                  tout-en-un. Suivez, entretenez et optimisez vos déplacements
                  en quelques touches.
                </p>
              </div>
