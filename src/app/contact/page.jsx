...
.ct-arrow { animation: ctArrow 1.2s ease-in-out infinite; }
      ...
      <div style={{ fontFamily: "'Archivo', sans-serif", background: "#ecf5f5", position: "relative", overflow: "hidden" }}>
        ...
        <section style={{
          ...
          <p style={{ color: "#6b7280", fontSize: 18, fontWeight: 500, maxWidth: "100%", margin: "0 auto", whiteSpace: "nowrap" }}>            Notre équipe est disponible pour répondre à toutes vos questions.
          </p>
        </section>

        {/* ══ MIDDLE ══ */}
        <section style={{ padding: "0 20px 70px", position: "relative", zIndex: 2 }}>
          <div style={{ maxWidth: "90vw", margin: "0 auto", padding: "0 24px", display: "grid", gridTemplateColumns: "1fr 1.15fr", gap: 60, alignItems: "start" }}>
            ...
            <div>
              ...
              <p style={{ color: "#6b7280", fontSize: 17, lineHeight: 1.75, marginBottom: 36 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 22 }}>
                ...
                <div>
                  <p style={{ color: "#005f69", fontWeight: 900, fontSize: 17, letterSpacing: .3 }}>+229 99 98 43 45</p>
            ...
            <div style={{ background: "linear-gradient(145deg, #005f69 0%, #004a52 100%)", borderRadius: 20, padding: "36px 32px", boxShadow: "0 20px 60px rgba(0,95,105,.3)" }}>
              ...
              <p style={{ color: "rgba(255,255,255,.65)", fontSize: 15, marginBottom: 28, lineHeight: 1.6 }}>
              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit}>
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                    <div>
                      <label style={{ color: "rgba(255,255,255,.6)", fontSize: 13, fontWeight: 700, letterSpacing: .5, display: "block", marginBottom: 6, textTransform: "uppercase" }}>Votre nom</label>
                    ...
                    <div>
                      <label style={{ color: "rgba(255,255,255,.6)", fontSize: 13, fontWeight: 700, letterSpacing: .5, display: "block", marginBottom: 6, textTransform: "uppercase" }}>Votre email</label>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 12 }}>
                    <div>
                      <label style={{ color: "rgba(255,255,255,.6)", fontSize: 13, fontWeight: 700, letterSpacing: .5, display: "block", marginBottom: 6, textTransform: "uppercase" }}>Service</label>
                    ...
                    <div>
                      <label style={{ color: "rgba(255,255,255,.6)", fontSize: 13, fontWeight: 700, letterSpacing: .5, display: "block", marginBottom: 6, textTransform: "uppercase" }}>Date</label>
                  ...
                  <div style={{ marginBottom: 22 }}>
                    <label style={{ color: "rgba(255,255,255,.6)", fontSize: 13, fontWeight: 700, letterSpacing: .5, display: "block", marginBottom: 6, textTransform: "uppercase" }}>Votre message</label>
                  ...
                  >
                    Prendre rendez-vous <ArrowRight weight="bold" style={{ width: 16, height: 16 }} className="ct-arrow" />
                  </button>
                </form>
              )}
            </div>
        ...
        <section style={{ padding: "0 20px 80px", position: "relative", zIndex: 2 }}>
          <div style={{ maxWidth: "90vw", margin: "0 auto", padding: "0 24px", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}>
            ...
            <div className="ct-card-teal">
              ...
              <p style={{ color: "rgba(255,255,255,.75)", fontSize: 13, lineHeight: 1.75, marginBottom: 15 }}>
                Soumettez un ticket d'assistance et notre équipe vous prendra en charge rapidement pour résoudre votre problème.
              </p>
<Link href="/support" className="ct-link-white" style={{ marginTop: "15px", alignSelf: "flex-start" }}>Nous contacter</Link>
            </div>
            ...
            <div className="ct-card-light">
              ...
              <p style={{ color: "#6b7280", fontSize: 13, lineHeight: 1.75, marginBottom: 15 }}>
                Appelez notre centre d'assistance disponible 7j/7 pour toute question sur nos établissements partenaires.
              </p>
<Link href="tel:+22997000000" className="ct-link-dark" style={{ marginTop: "15px", alignSelf: "flex-start" }}>Nous contacter</Link>
...
<Link href="/news" className="ct-link-dark" style={{ marginTop: "15px", alignSelf: "flex-start" }}>Nous contacter</Link></div>
